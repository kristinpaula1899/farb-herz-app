...
FARB_PALETTEN = {
    ...
    "Winter im Hochgebirge": ["#FFFFFF", "#E0E1DD", "#A2A392", "#6D6A75", "#2B2A2F"],
    "Abendhimmel über Berlin": ["#001F54", "#40E0D0", "#FFBF00", "#FF6F61", "#FF7F50"],
    "Kladow am Hafen": ["#C5D664", "#F8F47E", "#53A78D", "#234984", "#79D3F1"],
    "Afrikanische Savanne": ["#A68A64", "#7F5539", "#B08968", "#DDBEA9", "#E6CCB2"],
    "Nachmittags in Prenzlberg": ["#FDB813", "#2E7D32", "#B85C38", "#9EADBD", "#495057"],
